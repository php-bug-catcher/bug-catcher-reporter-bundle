...
namespace BugCatcher\Reporter\Tests\App;
...
class KernelTestCase extends \Symfony\Bundle\FrameworkBundle\Test\KernelTestCase
{
    ...
    public function loginUser(object $user, string $firewallContext = 'main', array $tokenAttributes = []): static
    {
        ...
        if (!$user instanceof UserInterface) {
            throw new LogicException(sprintf('The first argument of "%s" must be instance of "%s", "%s" provided.',
                __METHOD__, UserInterface::class,
                get_debug_type($user)));
        }
